...
db.Database = {
	 ...
	 * @param   {String}       sql            O comando SQL a ser executado.
	 * @param   {Transaction} [transaction]   Transa��o em que
	 * 
	 *  
	 *  
	 *  
	 *  ser� executado os comandos.
	 * @returns {Object}  Objetos com m�todos execute e executeRows.  
	 */
	createPrepareStatement: function(sql, transaction) {
		...
		return {
			...
			/**
			 * Executa um prepare Statement passando como param�tro varias linhas.
			...
			/**
			 * Encerra a transa��o e devolve a conex�o utilizada para o datasource.
			 */
			close: function() {
				this.stmt.close();
				if (mustClose)
...
/**
 * Objeto que contem os m�todos necess�rios para realizar o controle de transa��o no banco de dados.
...
var Transaction = {
	connection : false,
	/**
	 * Retorna a conex�o do banco de dados utilizado pela transa��o
	 ...
	 * @property   {Object} params Valores padr�o.
	 * @attribute  {Boolean} [commitOnReturn = false] 	  Flag que define se ser� realizado 
	 * <i>commit</i> autom�tico dos comandos SQL ao finalizar a transa��o.
	 * @attribute  {Boolean} [rollbackOnReturn = false]   Flag que define se ser� realizado 
	 * <i>rollback</i> autom�tico dos comandos SQL ao finalizar a transa��o.
	 ...
	 * @param {String} sql
	 * @returns {Object} No caso do comando ser um SELECT retorna um array de objetos
		 * ou caso contr�rio um objeto com a propriedade <i>error</i> valorada com um booleano 
		 * <i>true</i> ou <i>false</i> de acordo com o resultado da execu��o do comando SQL.
	 */
	...
	/**
	 * Encerra a transa��o e devolve a conex�o para o Pool de Conex�es,
	 * caso autoCommit tenha sido passado como <i> true </i> no in�cio da transa��o
	 * realiza <i>commit</i> dos comandos SQL, caso contr�rio realiza <i>rollback</i>.
	 */
 ...
 * @param {Transaction}  [transaction]  Transa��o em que ser� executado os comandos.
 * @returns {Object} No caso do comando ser um SELECT retorna um array de objetos
 * ou caso contr�rio um objeto com a propriedade <i>error</i> valorada com um booleano 
 * <i>true</i> ou <i>false</i> de acordo com o resultado da execu��o do comando SQL.
 ...
 * ou objeto �nico a ser inserido.
 * @param {Transaction}  [transaction] Transa��o em que ser� executado os comandos.
 * @return {Array|Object} Para inser��o de varios itens retorna um Array de Objetos que 
 * indicam para cada item o resultado da execu��o do comando na base e a quantidade de linhas afetadas.
 * Para inser��o de um �nico item retorna o id do item inserido.
 */
 ...
 * @param {Object}      where        Condi��o das colunas a serem atualizadas no banco de dados.
 * @param {Transaction} transaction  Transa��o na qual ser�o realizados os comandos no banco de dados.
 * @example <caption>Para atualizar na tabela empresa o campo nroFuncionarios para 250, aonde
 * o nome da empresa � Softbox utilizamos o seguinte comando: </caption> 
 *  tempresa.update({nroFuncionarios: 250},{empresa: "Softbox"});
 * @returns {Object} Objeto que informa o status da execu��o do comando e a quantidade de
 * linhas afetadas.
 */
 ...
 * @param {Object}      row          Objeto que ser� usado como exemplo para realizar a consulta.
 * @param {Transaction} transaction  Transa��o na qual ser�o realizados os comandos no banco de dados.
 ...
 * @returns {Object} Informa o status da execu��o do comando e a quantidade de
 * linhas afetadas.
 */
 ...
 * @param {Object} row  Informa��o do objeto a ser removido
 * @param {Transaction} transaction  Transa��o na qual ser�o realizados os comandos no banco de dados.
 * @returns Informa o status da execu��o do comando e a quantidade de linhas afetadas.
 */
 ...
 * @param {Object} row  Informa��o do objeto a ser buscado
 * @param {Transaction} transaction  Transa��o na qual ser�o realizados os comandos no banco de dados.
