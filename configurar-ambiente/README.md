...
![Criando projeto](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto1.png)

![Criando projeto](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto2.png)
...
![Configuracao novo projeto](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto3.png)

Nesta tela não há necessidade de modificar nada, apenas siga para a próxima.

![Configuracao novo projeto](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto4.png)

Nesta parte é importante marcar a opção de gerar o web.xml automaticamente, conforme imagem abaixo:

![Configuracao novo projeto](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto5.png)
...
![Jars na pasta lib](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto6.png)



Feito isso, basta que adicionemos nosso novo projeto ao Tomcat, conforme as imagens abaixo:

![Adicionando projeto ao servidor](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto7.png)

![Adicionando projeto ao servidor](https://github.com/cneryjr/boxjs/tree/master/imagens/firstProject/criando_projeto8.png)

É importante lembrar que todos os arquivos `.js` devem estar dentro da pasta boxjs ou algum subdiretório, conforme a 
imagem abaixo.


![Hello World](https://github.com/cneryjr/boxjs/tree/master/imagens/hello_dentro_boxjs.png)
